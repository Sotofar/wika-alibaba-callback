...
const WIKA_ACCESS_DIR = path.join(ROOT_DIR, "WIKA", "projects", "wika", "access");
const XD_ACCESS_DIR = path.join(ROOT_DIR, "XD", "projects", "xd", "access");
...
const WIKA_VALIDATED_INTERFACES = [
  ...
  { module: "runtime", endpoint: "/integrations/alibaba/auth/debug", method: "GET", expected_scope: "wika_oauth_runtime", known_required_params: [], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "historically_validated", source_of_truth: "WIKA/projects/wika/access/validated-flow.md + app.js" },
  { module: "runtime", endpoint: "/integrations/alibaba/auth/start", method: "GET", expected_scope: "wika_oauth_entry", known_required_params: [], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "historically_validated", source_of_truth: "README.md + WIKA/projects/wika/access/validated-flow.md" },
  { module: "runtime", endpoint: "/integrations/alibaba/callback", method: "GET", expected_scope: "wika_oauth_callback", known_required_params: ["code", "state"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "historically_validated", source_of_truth: "README.md + WIKA/projects/wika/access/validated-flow.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/list", method: "GET", expected_scope: "wika_products_read", known_required_params: [], pagination_rule: "page_size optional; paged list reads", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/score", method: "GET", expected_scope: "wika_products_read", known_required_params: ["product_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/detail", method: "GET", expected_scope: "wika_products_read", known_required_params: ["product_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/groups", method: "GET", expected_scope: "wika_products_read", known_required_params: ["group_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "categories", endpoint: "/integrations/alibaba/wika/data/categories/tree", method: "GET", expected_scope: "wika_categories_read", known_required_params: [], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "categories", endpoint: "/integrations/alibaba/wika/data/categories/attributes", method: "GET", expected_scope: "wika_categories_read", known_required_params: ["cat_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/schema", method: "GET", expected_scope: "wika_products_read", known_required_params: ["cat_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/schema/render", method: "GET", expected_scope: "wika_products_read", known_required_params: ["cat_id", "product_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "products", endpoint: "/integrations/alibaba/wika/data/products/schema/render/draft", method: "GET", expected_scope: "wika_products_read", known_required_params: ["cat_id", "product_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md + WIKA/docs/framework/WIKA_ICBU商品类目官方文档归类.md" },
  { module: "media", endpoint: "/integrations/alibaba/wika/data/media/list", method: "GET", expected_scope: "wika_media_read", known_required_params: [], pagination_rule: "page-based read", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "media", endpoint: "/integrations/alibaba/wika/data/media/groups", method: "GET", expected_scope: "wika_media_read", known_required_params: [], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "customers", endpoint: "/integrations/alibaba/wika/data/customers/list", method: "GET", expected_scope: "wika_customer_probe_read", known_required_params: [], pagination_rule: "window-based parameter probe", date_window_rule: "current route acts as permission probe", prior_status: "validated_probe_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "orders", endpoint: "/integrations/alibaba/wika/data/orders/list", method: "GET", expected_scope: "wika_orders_read", known_required_params: [], pagination_rule: "role/start_page/page_size", date_window_rule: "partial and contract-sensitive", prior_status: "validated_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md + WIKA/docs/framework/WIKA_订单参数契约对账.md" },
  { module: "orders", endpoint: "/integrations/alibaba/wika/data/orders/detail", method: "GET", expected_scope: "wika_orders_read", known_required_params: ["e_trade_id"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "route_exists_contract_sensitive", source_of_truth: "WIKA/docs/framework/WIKA_订单参数契约对账.md" },
  { module: "orders", endpoint: "/integrations/alibaba/wika/data/orders/fund", method: "GET", expected_scope: "wika_orders_read", known_required_params: ["e_trade_id", "data_select"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "route_exists_contract_sensitive", source_of_truth: "WIKA/docs/framework/WIKA_订单参数契约对账.md" },
  { module: "orders", endpoint: "/integrations/alibaba/wika/data/orders/logistics", method: "GET", expected_scope: "wika_orders_read", known_required_params: ["e_trade_id", "data_select"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "route_exists_contract_sensitive", source_of_truth: "WIKA/docs/framework/WIKA_订单参数契约对账.md" },
  { module: "orders", endpoint: "/integrations/alibaba/wika/data/orders/draft-types", method: "GET", expected_scope: "wika_orders_read", known_required_params: [], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_probe_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "reports", endpoint: "/integrations/alibaba/wika/reports/products/management-summary", method: "GET", expected_scope: "wika_reports_read", known_required_params: [], pagination_rule: "internally paged against products list", date_window_rule: "n/a", prior_status: "validated_report_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "reports", endpoint: "/integrations/alibaba/wika/reports/products/minimal-diagnostic", method: "GET", expected_scope: "wika_reports_read", known_required_params: [], pagination_rule: "sample-limited aggregation", date_window_rule: "n/a", prior_status: "validated_report_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "reports", endpoint: "/integrations/alibaba/wika/reports/orders/minimal-diagnostic", method: "GET", expected_scope: "wika_reports_read", known_required_params: [], pagination_rule: "sample-limited aggregation", date_window_rule: "n/a", prior_status: "validated_report_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  ...
  { module: "tools", endpoint: "/integrations/alibaba/wika/tools/reply-draft", method: "POST", expected_scope: "wika_external_draft_only", known_required_params: ["inquiry_text"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_tool_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" },
  { module: "tools", endpoint: "/integrations/alibaba/wika/tools/order-draft", method: "POST", expected_scope: "wika_external_draft_only", known_required_params: ["line_items"], pagination_rule: "n/a", date_window_rule: "n/a", prior_status: "validated_tool_route", source_of_truth: "WIKA/docs/framework/WIKA_已上线能力复用清单.md" }
];
...
function buildDocumentationMarkdown(precheckResults, envBlocked) {
  const lines = ["# WIKA/XD access 过程记录", "", "更新时间：2026-04-10", "", "## 这轮做了什么", "", "1. 读取了 shared/access、WIKA/projects/wika/access、XD/projects/xd/access 与各级 AGENTS。", "2. 盘点了当前 app.js 中可见的 WIKA/XD route 面。", "3. 用 production 公共路由做了最小 precheck，多轮确认 `health/auth debug/products list/orders list`。", "4. 在不引入本地旁路、不新增写动作的前提下，把结果固化成 replay matrix、未决队列与 XD 覆盖矩阵。", "", "## 发现了什么", ""];
  if (envBlocked) {
  ...
  lines.push("- 当前工作树中 `WIKA/projects/wika/access` 和 `XD/projects/xd/access` 缺少目录级 AGENTS，需要补建。");
