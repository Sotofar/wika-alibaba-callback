### WIKA 阶段 47：正式运营报告包生成

- 实际起始 commit：`a089e97b056ba42176d3810921b77e1036472cc4`
- 本轮没有新增 API、没有新增 live route、没有新增写侧动作。
- 本轮只做一件事：把 stage46 报告系统变成可直接给不同角色使用的正式报告包。
- 新增交付物包括：
  - 管理层简报
  - 运营周报
  - 经营诊断报告
  ...
  - 人工接手清单
  - 正式运营报告包索引
  - 评分 JSON 与 deliverables evidence
- 本轮主要结论：
  - 正式报告包已可服务老板、运营负责人、店铺运营、产品运营、销售 / 跟单、人工接手人员
  - 主要报告评分全部达到可交付阈值
  - 广告分析仍依赖真实广告样本
  - 页面优化建议仍依赖人工盘点输入
